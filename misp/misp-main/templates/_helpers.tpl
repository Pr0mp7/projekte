...
{{/*
 ...
 in the values file. If the name is not set it will default to either misp.fullname if serviceAccount.create
 is true or default otherwise.
*/}}
*/}}
{{- define "misp.serviceAccountName" -}}
{{- if .Values.misp.serviceAccount.create }}
{{- default (include "misp.fullname" .) .Values.misp.serviceAccount.name }}
{{- else }}
